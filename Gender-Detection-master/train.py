...
image_files = [f for f in glob.glob(r'C:/Users/Arul Kani/Music/Gender-detection/Gender-Detection-master/gender_dataset_face' + "/**/*", recursive=True) if not os.path.isdir(f)]
